	            ...
	            <div id="exTab1" class="container">	
	                ...
	                <div class='rating-widget'>
	                    ...
	                    <div class="submitContainer">
	                    	<!-- 레이팅 버튼 -->
	                        <button class="ratingSubmit" type="submit"> 제출하기
	                        </button>
	                    </div>
	                </div>
	                <!-- 별점 -->
	          ...
	          <div class="recommendContainer">
	          	...
	          	<div class="recommendLayoutContainer">
			        <div class="slider-wrap">
			            ...
			            <!-- 10개 까지 z1 ~ z10 -->
			       		<c:forEach var="rec" items="${recSet}" varStatus="status">
			       		<div class="testBox z${status.index+1}">
    			...
    			<button id = "reButton" class="nextButton" type="button"> 다음 공고</button>
